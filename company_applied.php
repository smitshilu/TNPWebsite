...
<section class="middle">
	...
	<section class="center">
				<hgroup><h2 class="welcome"><center>Students Applied</center></h2></hgroup>
					...
					<?php 	
						...
						$query = "SELECT `Firstname`,`Lastname`,`Branch`,`Gender`,`Mobileno`, `Userid`  
									FROM `$id` WHERE `applied`='1'";
						...
						else
						{
							...
							while($result_set = mysql_fetch_array($result))
							{
								...
								echo "<td><form action=\"uploaded/".$result_set[5].".pdf\" method=post>
								<center><input class=buttons type=submit value=Download /></center></td>
								</form></tr>";
			...
			$export_query=mysql_query("SELECT *
  INTO OUTFILE \"c:/company/'{$id}'.csv\"
  ...
  WHERE applied=1");
		  	...
		  	echo "<a href=\"c:/company/".$id.".csv\" class=buttons>Download all details</a>";
		  	?>
	</section>
